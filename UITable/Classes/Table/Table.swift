...
class UITable: UIView {
    ...
    private let theme: TableThemeProvider
    ...
    private func customizeAppearance(theme: TableThemeProvider) {
    ...
    private func setupColumn(coordinateX x: CGFloat, rowIndex: CGFloat, columnIndex: Int, column: TableColumn, setupRowsOfColumn: (_ cellWidth: CGFloat, _ cellHeight: CGFloat) -> ()) {
    ...
    private func setupRow(coordinateX: CGFloat, cellWidth: CGFloat, cellHeight: CGFloat, columnIndex: Int, rowIndex: Int, cellContent: TableCellContent) {
    ...
    private func setupHeaderTableCell(x: CGFloat, title: String, columnIndex: Int, rowIndex: Int, cellSize: CGSize) -> TableCell<UILabel> {
        ...
        let request = TableCellRequest(isTopSeperatorEnabled: false, backgroundColor: backgroundColor, separatorColor: UIColor(cgColor: theme.borderColor))
    ...
    private func setupContentTableCell(x: CGFloat, cellContent: TableCellContent, columnIndex: Int, rowIndex: Int, cellSize: CGSize) -> TableCell<UIView> {
        ...
        let backgroundColor = columnIndex == highlightedColumnIndex ? highlightedColor : .clear
        let request = TableCellRequest(isTopSeperatorEnabled: true, backgroundColor: backgroundColor, separatorColor: UIColor(cgColor: theme.borderColor))
